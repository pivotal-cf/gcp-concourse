...
# -
source gcp-concourse/tasks/functions/misc.sh
# opsman_host
source gcp-concourse/tasks/functions/config-director-json-fn-opsman-curl.sh
# json_file_path
source gcp-concourse/tasks/functions/config-director-json-fn-opsman-auth.sh
# json_file_path
source gcp-concourse/tasks/functions/config-director-json-fn-opsman-json-to-post-data.sh
# opsman_host, pcf_opsman_admin_passwd
source gcp-concourse/tasks/functions/config-director-json-fn-opsman-extensions.sh
# -
source gcp-concourse/tasks/functions/config-director-json-fn-opsman-config-director.sh
